...
-- 3. WATCH HISTORY TABLE (Continue Watching across Phone, Tablet & PC)
...
-- Ensure columns exist if table was previously created
ALTER TABLE public.watch_history ADD COLUMN IF NOT EXISTS current_time NUMERIC DEFAULT 0;
ALTER TABLE public.watch_history ADD COLUMN IF NOT EXISTS duration NUMERIC DEFAULT 0;
ALTER TABLE public.watch_history ADD COLUMN IF NOT EXISTS last_watched TIMESTAMPTZ DEFAULT NOW();
